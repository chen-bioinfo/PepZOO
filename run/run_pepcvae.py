...
generator.pepcvae_analogue_generation(sequences=sequences,
...
# 统计优化结果
dic_all = {'PepCVAEZeroOpt': 0, 'PepCVAEOpt': 0, 'original': 0}
dic_first = {'PepCVAEZeroOpt': 0, 'PepCVAEOpt': 0, 'original': 0}
