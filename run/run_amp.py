...
# 加载数据
data = pd.read_csv('data/activate_amp.csv')
...
# # 结果排序
# txt = pd.read_csv(f'results/amp/Hydramp/result.csv')
...
# txt2.to_csv(f'results/amp/Hydramp/amp_case3.csv', index=False, encoding='utf-8')
# # 清空文件
# f = open(f'results/amp/Hydramp/result.csv', 'w')
# f.close()

# txt = pd.read_csv(f'results/amp/PepZOO/result.csv')
# # txt2 = txt.sort_values(by=['amp','mic','hydrophobicity', 'hydrophobic_moment', 'charge', 'isoelectric_point'], ascending=True)
# txt2 = txt.sort_values(by=['amp'], ascending=True)
# txt2.to_csv(f'results/amp/PepZOO/amp_case3.csv', index=False, encoding='utf-8')
# # 清空文件
...
# txt2 = txt.sort_values(by=['amp','mic','hydrophobicity', 'hydrophobic_moment', 'charge', 'isoelectric_point'], ascending=True)
txt2 = txt.sort_values(by=['amp'], ascending=True)
txt2.to_csv(f'results/amp_mic/Basic/amp_case1.csv', index=False, encoding='utf-8')
# 清空文件
...
# txt2 = txt.sort_values(by=['amp','mic','hydrophobicity', 'hydrophobic_moment', 'charge', 'isoelectric_point'], ascending=True)
txt2 = txt.sort_values(by=['amp'], ascending=True)
txt2.to_csv(f'results/amp_mic/BasicZOO/amp_case1.csv', index=False, encoding='utf-8')
# 清空文件
