...
# 结果排序
txt = pd.read_csv(f'results/mic/Hydramp/result.csv')
...
txt2.to_csv(f'results/mic/Hydramp/mic_case3.csv', index=False, encoding='utf-8')
# 清空文件
f = open(f'results/mic/Hydramp/result.csv', 'w')
f.close()

txt = pd.read_csv(f'results/mic/PepZOO/result.csv')
# txt2 = txt.sort_values(by=['amp','mic','hydrophobicity', 'hydrophobic_moment', 'charge', 'isoelectric_point'], ascending=True)
txt2 = txt.sort_values(by=['mic'], ascending=True)
txt2.to_csv(f'results/mic/PepZOO/mic_case3.csv', index=False, encoding='utf-8')
# 清空文件
f = open(f'results/mic/PepZOO/result.csv', 'w')
f.close()
